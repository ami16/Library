...
public class BookService {
   ...
   public static List<Book2> bookList = new ArrayList<>();

   public static List<Book2> getBookList() {
      return bookList;
   }

   public static List<Book2> getBookList(int userId) {
      List<Book2> result = bookList.stream()
